...
some other sample code in R or python 3. while github renders Jupyter notebooks pretty well, click the link below to open the notebooks interactively via Binder (esp useful for .ipynb/jupyter notebook files)  
