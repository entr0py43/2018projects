...
```
How it relates to the leaderboard scores... it doesn't, it's just for checking your own ideas re: optimization.  You would do a test-train split if you wanted to have a better idea of out-of-bag performance of your binary classifier. 
